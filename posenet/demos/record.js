...
$("#start").click(function()
{
  ...
  if(startRecord)
  {
    var myRec = setInterval(recorder, 1000);
    var counter = 0;
    ...
    function recorder()
    {
      ...
      if (counter == 10 ){
        ...
        $("#keyoutput").text(json);
        console.log("----------------------ENDOFRECORD------------------------");
        clearInterval(myRec);
      }
      else {
        recKeypoints.keypoints.push([avatarKeypoints]);
        console.log("Keypoints in "+counter+" sec : ", recKeypoints);
      }
    }
...
$("#copy").click(function()
{
  ...
  alert("Keypoints copied to clipboard !");
});
