...
},{"core-js/library/fn/json/stringify":"node_modules/core-js/library/fn/json/stringify.js"}],"js/prism.js":[function(require,module,exports) {
"use strict";
...
var Prism = function () {
      ...
      if (o && (l = (o.className.match(e) || [, ""])[1], s = t.languages[l]), s) {
        ...
        if (g) {
          ...
          if (t.hooks.run("before-highlight", u), r && self.Worker) {
            ...
            }, c.postMessage((0, _stringify.default)({
              language: u.language,
              code: u.code
            }));
  ...
  if (n.stringify = function (e, a, r) {
    ...
    var n = JSON.parse(e.data),
        a = n.language,
        r = n.code;
    self.postMessage(_JSON$stringify(t.util.encode(t.tokenize(r, t.languages[a])))), self.close();
...
;
},{"babel-runtime/core-js/json/stringify":"node_modules/babel-runtime/core-js/json/stringify.js"}]},{},["js/prism.js"], null)
//# sourceMappingURL=/prism.7d6549da.map